...
public class CommunityContentFactory{
    private static final Logger LOGGER = Logger.getLogger(CommunityContentFactory.class.getName());

    public CommunityContentFactory()
    {

    }

    public static CommunityContent createCommunityContent(String fullyQualifiedName, Object ... base)
    {
        CommunityContent record = null;
        try {
            Class<?> clz = Class.forName(fullyQualifiedName);
            Constructor<?> constructor = clz.getDeclaredConstructors()[0];
            record = (CommunityContent) constructor.newInstance(base);
        } 
