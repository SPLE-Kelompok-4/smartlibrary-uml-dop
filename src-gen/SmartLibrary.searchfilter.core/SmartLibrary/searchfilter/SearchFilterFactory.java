...
public class SearchFilterFactory{
    ...
    public static SearchFilter createSearchFilter(String fullyQualifiedName, Object ... base)
    {
        SearchFilter record = null;
        try {
            Class<?> clz = Class.forName(fullyQualifiedName);
            Constructor<?> constructor = clz.getDeclaredConstructors()[0];
            record = (SearchFilter) constructor.newInstance(base);
        } 
